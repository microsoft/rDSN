...
macro(ms_setup_boost STATIC_LINK PACKAGES BOOST_LIBS)
    ...
    if(DSN_BOOST_HEADER_ONLY AND Boost_VERSION LESS 105300)
...
function(dsn_setup_link_path)
    link_directories(${BOOST_LIBRARYDIR} ${Boost_LIBRARY_DIRS} ${CMAKE_ARCHIVE_OUTPUT_DIRECTORY} ${CMAKE_LIBRARY_OUTPUT_DIRECTORY})
    if(DSN_BUILD_RUNTIME)
    else()
